...
+ (void)customAlertControllerAppearance {
    ...
    QMUIAlertController *appearance = QMUIAlertController.appearance;
    
    UIColor *bgColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<QDThemeProtocol> * _Nullable theme) {
        if ([identifier isEqualToString:QDThemeIdentifierDark]) {
            return UIColor.qd_backgroundColorLighten;
        }
        return UIColorWhite;
    }];
    
    appearance.alertSeparatorColor = UIColor.qd_separatorColor;
    appearance.alertHeaderBackgroundColor = bgColor;
    appearance.alertButtonBackgroundColor = bgColor;
    appearance.alertButtonHighlightBackgroundColor = UIColor.qd_backgroundColorHighlighted;
    
    appearance.alertTitleAttributes = @{
        NSForegroundColorAttributeName:UIColor.qd_mainTextColor,
        NSFontAttributeName:UIFontBoldMake(17),
        NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:0 lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]
    };
    appearance.alertMessageAttributes = @{
        NSForegroundColorAttributeName:UIColor.qd_mainTextColor,
        NSFontAttributeName:UIFontMake(13),
        NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:0 lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]
    };
    
    
    appearance.sheetContentCornerRadius = 4;
    appearance.sheetCancelButtonMarginTop = 5;
    appearance.sheetContentMaximumWidth = SCREEN_WIDTH;
    appearance.sheetContentMargin = UIEdgeInsetsMake(12, 12, 12, 10);
    
    appearance.sheetSeparatorColor = UIColor.qd_separatorColor;
    appearance.sheetHeaderBackgroundColor = bgColor;
    appearance.sheetButtonBackgroundColor = bgColor;
    appearance.sheetButtonHighlightBackgroundColor = UIColor.qd_backgroundColorHighlighted;
    
    appearance.sheetTitleAttributes = @{
        NSForegroundColorAttributeName:UIColor.qd_titleTextColor,
        NSFontAttributeName:UIFontBoldMake(17),
        NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:0 lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]
    };
    appearance.sheetMessageAttributes = @{
        NSForegroundColorAttributeName:UIColor.qd_mainTextColor,
        NSFontAttributeName:UIFontMake(13),
        NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:0 lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]
    };
    appearance.sheetButtonAttributes = @{
        NSForegroundColorAttributeName:UIColor.qd_titleTextColor,
        NSFontAttributeName:[UIFont systemFontOfSize:14 weight:UIFontWeightMedium],
        NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:0 lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]
    };
    appearance.sheetCancelButtonAttributes = @{
        NSForegroundColorAttributeName:UIColor.qd_titleTextColor,
        NSFontAttributeName:[UIFont systemFontOfSize:14 weight:UIFontWeightMedium],
        NSParagraphStyleAttributeName:[NSMutableParagraphStyle qmui_paragraphStyleWithLineHeight:0 lineBreakMode:NSLineBreakByTruncatingTail textAlignment:NSTextAlignmentCenter]
    };
...
+ (void)customDialogViewControllerAppearance {
    ...
    appearance.titleLabelTextColor = UIColor.qd_titleTextColor;
    appearance.subTitleLabelTextColor = UIColor.qd_mainTextColor;
    ...
    appearance.buttonBackgroundColor = appearance.backgroundColor;
}
