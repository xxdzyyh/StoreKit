...
@property(nonatomic, strong) UIColor *qd_shopMainColor;

/// 起始渐变色
@property (nonatomic, strong) UIColor *qd_startColor;

/// 终止渐变色
@property (nonatomic, strong) UIColor *qd_endColor;
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        /// 起始渐变色
        self.qd_startColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<QDThemeProtocol> *theme) {
            return theme.themeStartColor;
        }];
        
        /// 终止渐变色
        self.qd_endColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, __kindof NSObject<NSCopying> * _Nullable identifier, NSObject<QDThemeProtocol> *theme) {
            return theme.themeEndColor;
        }];
        ...
        self.qd_shopMainColor = [UIColor qmui_colorWithThemeProvider:^UIColor * _Nonnull(__kindof QMUIThemeManager * _Nonnull manager, NSString * _Nullable identifier, NSObject<QDThemeProtocol> * _Nullable theme) {
            return theme.themeShopMainColor;
        }];
...
+ (UIColor *)qd_shopMainColor {
    return QDThemeManager.sharedInstance.qd_shopMainColor;
}

+ (UIColor *)qd_startColor {
    return QDThemeManager.sharedInstance.qd_startColor;
}

+ (UIColor *)qd_endColor {
    return QDThemeManager.sharedInstance.qd_endColor;
}
